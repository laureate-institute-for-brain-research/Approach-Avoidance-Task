...
if __name__ == '__main__':
    ...
    session_params = StimToolLib.get_var_dict_from_file('Default.params', {'SID':sid, 'raID':raID, 'study_sf':study_sf }) #initialize default session parameters--SID and raID always come from the dialogue box
    ...
    if thisInfo[2] == 'free':
        ...
        with open(thisInfo[2]) as f:
            ...
            session_params['task_list']=thisInfo[2]
        free = False
